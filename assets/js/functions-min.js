! function (t, e, i, n) {
   ...
   function s() {
      ...
      $(".slider--prev2, .slider--next2").click(function () {
         var t = $(this),
            e = $(".slider2").find(".slider--item-left2"),
            i = $(".slider2").children().index(e),
            n = $(".slider2").find(".slider--item-center2"),
            s = $(".slider2").children().index(n),
            r = $(".slider2").find(".slider--item-right2"),
            o = $(".slider2").children().index(r),
            a = $(".slider2").children().length,
            l = $(".slider--item-left2"),
            c = $(".slider--item-center2"),
            h = $(".slider--item-right2"),
            u = $(".slider--item2");
         $(".slider2").animate({
            opacity: 0
         }, 400), setTimeout(function () {
            t.hasClass("slider--next2") ? a - 1 > i && a - 1 > s && a - 1 > o ? (l.removeClass("slider--item-left2").next().addClass("slider--item-left2"), c.removeClass("slider--item-center2").next().addClass("slider--item-center2"), h.removeClass("slider--item-right2").next().addClass("slider--item-right2")) : i === a - 1 ? (u.removeClass("slider--item-left2").first().addClass("slider--item-left2"), c.removeClass("slider--item-center2").next().addClass("slider--item-center2"), h.removeClass("slider--item-right2").next().addClass("slider--item-right2")) : s === a - 1 ? (l.removeClass("slider--item-left2").next().addClass("slider--item-left2"), u.removeClass("slider--item-center2").first().addClass("slider--item-center2"), h.removeClass("slider--item-right2").next().addClass("slider--item-right2")) : (l.removeClass("slider--item-left2").next().addClass("slider--item-left2"), c.removeClass("slider--item-center2").next().addClass("slider--item-center2"), u.removeClass("slider--item-right2").first().addClass("slider--item-right2")) : 0 !== i && 0 !== s && 0 !== o ? (l.removeClass("slider--item-left2").prev().addClass("slider--item-left2"), c.removeClass("slider--item-center2").prev().addClass("slider--item-center2"), h.removeClass("slider--item-right2").prev().addClass("slider--item-right2")) : 0 === i ? (u.removeClass("slider--item-left2").last().addClass("slider--item-left2"), c.removeClass("slider--item-center2").prev().addClass("slider--item-center2"), h.removeClass("slider--item-right2").prev().addClass("slider--item-right2")) : 0 === s ? (l.removeClass("slider--item-left2").prev().addClass("slider--item-left2"), u.removeClass("slider--item-center2").last().addClass("slider--item-center2"), h.removeClass("slider--item-right2").prev().addClass("slider--item-right2")) : (l.removeClass("slider--item-left2").prev().addClass("slider--item-left2"), c.removeClass("slider--item-center2").prev().addClass("slider--item-center2"), u.removeClass("slider--item-right2").last().addClass("slider--item-right2"))
         }, 400), $(".slider2").animate({
            opacity: 1
         }, 400)
      })
      ...
      $(".slider--prev3, .slider--next3").click(function () {
         var t = $(this),
            e = $(".slider3").find(".slider--item-left3"),
            i = $(".slider3").children().index(e),
            n = $(".slider3").find(".slider--item-center3"),
            s = $(".slider3").children().index(n),
            r = $(".slider3").find(".slider--item-right3"),
            o = $(".slider3").children().index(r),
            a = $(".slider3").children().length,
            l = $(".slider--item-left3"),
            c = $(".slider--item-center3"),
            h = $(".slider--item-right3"),
            u = $(".slider--item3");
         $(".slider3").animate({
            opacity: 0
         }, 400), setTimeout(function () {
            t.hasClass("slider--next3") ? a - 1 > i && a - 1 > s && a - 1 > o ? (l.removeClass("slider--item-left3").next().addClass("slider--item-left3"), c.removeClass("slider--item-center3").next().addClass("slider--item-center3"), h.removeClass("slider--item-right3").next().addClass("slider--item-right3")) : i === a - 1 ? (u.removeClass("slider--item-left3").first().addClass("slider--item-left3"), c.removeClass("slider--item-center3").next().addClass("slider--item-center3"), h.removeClass("slider--item-right3").next().addClass("slider--item-right3")) : s === a - 1 ? (l.removeClass("slider--item-left3").next().addClass("slider--item-left3"), u.removeClass("slider--item-center3").first().addClass("slider--item-center3"), h.removeClass("slider--item-right3").next().addClass("slider--item-right3")) : (l.removeClass("slider--item-left3").next().addClass("slider--item-left3"), c.removeClass("slider--item-center3").next().addClass("slider--item-center3"), u.removeClass("slider--item-right3").first().addClass("slider--item-right3")) : 0 !== i && 0 !== s && 0 !== o ? (l.removeClass("slider--item-left3").prev().addClass("slider--item-left3"), c.removeClass("slider--item-center3").prev().addClass("slider--item-center3"), h.removeClass("slider--item-right3").prev().addClass("slider--item-right3")) : 0 === i ? (u.removeClass("slider--item-left3").last().addClass("slider--item-left3"), c.removeClass("slider--item-center3").prev().addClass("slider--item-center3"), h.removeClass("slider--item-right3").prev().addClass("slider--item-right3")) : 0 === s ? (l.removeClass("slider--item-left3").prev().addClass("slider--item-left3"), u.removeClass("slider--item-center3").last().addClass("slider--item-center3"), h.removeClass("slider--item-right3").prev().addClass("slider--item-right3")) : (l.removeClass("slider--item-left3").prev().addClass("slider--item-left3"), c.removeClass("slider--item-center3").prev().addClass("slider--item-center3"), u.removeClass("slider--item-right3").last().addClass("slider--item-right3"))
         }, 400), $(".slider3").animate({
            opacity: 1
         }, 400)
      })
